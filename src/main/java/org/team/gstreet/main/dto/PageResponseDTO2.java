package org.team.gstreet.main.dto;
...
public class PageResponseDTO2<E> {
    ...
    public PageResponseDTO2(PageRequestDTO2 pageRequestDTO, int count){
        this.page = pageRequestDTO.getPage();
        this.size = pageRequestDTO.getSize();
        this.count = count;
        //임시 end   3/10.0 = 0.3 => 1 * 10 => 10
        int tempEnd = (int)(Math.ceil(page/(double)size)) * 8;
    ...
    public PageResponseDTO2(PageRequestDTO2 pageRequestDTO, int count, List<E> dtoList){
